...
def annotate_sublevel(data_path: str, 
    ...
    if integrate_path is not None:
        ...
        for focus_main_level_type in all_main_level_celltype:
            ...
            if os.path.exists(f'./output/data/subtype_{focus_main_level_type}.csv'):
    ...
    result = f"Annotated subtypes. adata saved in {adata_output_save_path} of key 'sub_level_{key_select}'. \
        gene markers saved in f'./output/data/subtype_xxx.csv'.\
