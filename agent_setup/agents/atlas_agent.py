...
def create_atlas_agent(llm):
    ...
    2. Match cell types, and match brain regions to find the matched cell types symbols and brain regions symbols in the spatial brain atlas using `match_brain_regions` and `match_brain_type`.
